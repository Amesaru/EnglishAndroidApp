...
import com.example.test.databinding.ActivityStudentChangePhoneBinding
...
class StudentChangePhone : AppCompatActivity() {

    data class phoneBody(val phone: String)

    data class codeBody(val code: String)

    private lateinit var binding : ActivityStudentChangePhoneBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStudentChangePhoneBinding.inflate(layoutInflater)
        ...
        binding.RequestButton.setOnClickListener {
            ...
            val request = Request.Builder()
                .url("http://10.0.2.2:8080/profileApi/startPhoneConfirmation")
                .post(requestBody)
        ...
        binding.confirmButton.setOnClickListener {
            ...
            val request = Request.Builder()
                .url("http://10.0.2.2:8080/profileApi/completePhoneConfirmation")
                .post(requestBody)
                .header("Content-Type", "application/json")
                .header("Authorization", "Bearer " + GlobalVars.accessToken)
                .build()
